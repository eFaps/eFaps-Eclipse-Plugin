...
/**
 * This class is a wrapper for the simple logging facade to print the
 * logging information to the eclipse console of the eFaps eclipse plugin.
 *
 * @see Logger interface of the simple logging facade
 * @author The eFaps Team
 * @version $Id$
 */
public class SLF4JOverEclipseConsole
    implements Logger
{
